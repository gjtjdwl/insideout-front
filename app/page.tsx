            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 break-keep">{feature.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-row mb-40">
            <div className="flex flex-col justify-between py-12 m-4 text-lg">
              ...
              <div className="bg-customPink mt-5 p-3 rounded">
                <p className="text-left text-black">심리도를 통한 심리 상담 추천</p>
                <p className="text-left text-black">자신의 심리 검토</p>
                <p className="text-left text-black">AI 분석을 통한 심리도 파악</p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between py-12 m-4 text-lg">
              ...
              <div className="bg-[#deeafa] mb-3 p-3 rounded">
                ...
                <p className="text-left text-black">AI 요약을 통한 개선방안 제공</p>
                <p className="text-left text-black">
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <div className="text-sm text-gray-600 mt-2">생활 만족도 개선</div>
                </div>
              </motion.div>
              ...
              >
                <div className="relative">
                  <div className="text-green-800 font-semibold mb-2">신체 건강</div>
