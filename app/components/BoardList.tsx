...
export default function BoardList({ boardList, name, onItemClick }: BoardListProps) {
  ...
  return (
    <ul role="list" className="">
      {boardList.map((inquiry,index) => (
        <li key={index} onClick={() => onItemClick(index)} className="flex items-center justify-between border-b my-5 pb-5  gap-x-6  cursor-pointer">
          {/* <Link href={`/${name}/${index}`} className='flex items-center justify-between border-b my-5 pb-5 '> */}
